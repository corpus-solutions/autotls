...
The reason for forking was to updating guide to better usage of creating SSL for modern certificate requirents. Subject Alt Names is require for modern certificate.
...
<details>
<summary> GENERICSSL Cert Generator </summary>
...
$ docker run -v /tmp/certs:/certs \
  ...
  -e SSL_IP=127.0.0.1  patrick0057/genericssl
```
